...
const basePath = '/cnno-1775110555120';
...
export default function Home() {
  ...
  const products = [{ n: 'OG Rolls', d: 'Our classic cinnamon rolls, baked fresh with carefully selected ingredients and a perfect blend of traditional and modern techniques, offering a soft, fragrant, and indulgent treat that warms the soul.', i: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=1200&q=80', icon: 'domain' }, { n: 'Pistachio Rolls', d: 'A delightful twist on our classic rolls, infused with the nutty flavor of pistachios, providing a unique and exciting experience for those looking to try something new.', i: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=1200&q=80', icon: 'architecture' }, { n: 'Chocolate Rolls', d: 'For chocolate lovers, our chocolate rolls are a dream come true, with rich, velvety chocolate swirled through our signature dough, creating a decadent treat that\'s hard to resist.', i: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=1200&q=80', icon: 'chair' }, { n: 'Baby Rolls', d: 'Bite-sized versions of our beloved cinnamon rolls, perfect for snacking on the go or sharing with friends and family, offering all the flavor and comfort of our larger rolls in a convenient, smaller package.', i: 'https://images.unsplash.com/photo-1504639725590-34d0984388bd?w=1200&q=80', icon: 'eco' }, { n: 'Party Box', d: 'The ultimate solution for gatherings and celebrations, our party box includes an assortment of our finest rolls, carefully selected to cater to a variety of tastes and preferences, ensuring that every guest leaves satisfied and delighted.', i: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=1200&q=80', icon: 'precision_manufacturing' }];
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">To craft artisanal cinnamon rolls that bring comfort, warmth, and indulgence to our community, while continuously innovating and upholding the highest standards of quality and creativity.</p>
                </div>
                <div className="space-y-2">
